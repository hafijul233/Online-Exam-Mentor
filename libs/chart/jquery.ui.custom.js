 ...
 (function($, undefined) {
     ...
     $.extend($.ui, {
         ...
         // these are odd functions, fix the API or move into individual libs
 ...
 (function($, undefined) {
     ...
     $.widget("ui.draggable", $.ui.mouse, {
         ...
         _trigger: function(type, event, ui) {
             ...
             if (type == "drag") this.positionAbs = this._convertPositionTo("absolute"); //The absolute position has to be recalculated after libs
         ...
         stop: function(event, ui) {
             ...
             $.each(inst.sortables, function() {
                 if (this.instance.isOver) {
                     ...
                     this.instance.cancelHelperRemoval = false; //Remove it in the sortable instance (so sortable libs like revert still work)
 ...
 (function($, undefined) {
     ...
     $.widget("ui.resizable", $.ui.mouse, {
         ...
         _mouseDrag: function(event) {
             ...
             // libs callbacks need to be called first
 ...
 (function($, undefined) {
     ...
     $.widget("ui.button", {
         ...
         _create: function() {
             ...
             // be overridden by individual libs
